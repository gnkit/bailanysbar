<div class="container">
    <div class="text-center bg-image mb-2"
        ...
        {{-- <div class="mask" style="background-color: rgba(3, 126, 243, 0.5);"> --}}
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);">
            <div class="p-4 d-flex justify-content-center align-items-center">
                <div class="text-white">
                    <h1 class="mb-3 fw-bold">{{ __('Qaratay') }}</h1>
                    <p class="mb-5 fw-bold ">{{ __('Барлық байланыс сіздің қолыңызда') }}</p>
                    <a class="btn btn-outline-light fw-bolder shadow-lg rounded-5" href="{{ route('register') }}"
                       role="button">
                        {{ __('Бастау') }}
                    </a>
                </div>
